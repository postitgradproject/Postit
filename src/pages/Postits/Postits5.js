...
const PageShell = (Page, previous) => {
  ...
  <table className={classes.table} id="myTable">
        <tr>
            ...
            <iframe className={classes.slide}  width="1075" height="800" src= "https://onedrive.live.com/embed?cid=B753023CFEF00415&amp;resid=B753023CFEF00415%211620&amp;authkey=ADCbyrShW3DNvoE&amp;em=2&amp;wdStartOn=1" id="view" frameborder="0"></iframe>
            </td>
