...
const PageShell = (Page, previous) => {
  ...
  <table className={classes.table} id="myTable">
        <tr>
            ...
            <iframe className={classes.slide}  width="1075" height="800" src= "https://onedrive.live.com/embed?cid=B753023CFEF00415&amp;resid=B753023CFEF00415%211611&amp;authkey=ANbkfIB2YjmYThI&amp;em=2&amp;wdAr=1.3333333333333333" id="view" frameborder="0"></iframe>
            </td>
